...
if (!isset($_SESSION['ruser'])) {
    if (isset($_REQUEST['rsignin'])) {
        ...
        $sql = "SELECT id, full_name FROM trainees WHERE phone_no='$remail' AND yellow_card='$rpassword' LIMIT 1";
             ...
             <div class="col-sm-6 col-md-4 text-white " style="background-color: rgba(0, 0, 0, 0.6); border-radius: 10px;">
                 <form action="" class="p-4 shadow-lg" method="POST" id="myForm">
                     ...
                     <div class="form-group">
                        ...
                        <input type="password" name="rpassword" placeholder="Enter yellow card" class="form-control">
                    </div>
