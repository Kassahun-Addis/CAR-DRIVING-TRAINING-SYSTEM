...
<h2 style="text-align: center; padding:10px;">Class Assigning List</h2>
   ...
   <div class="row mb-3" style="display: flex; justify-content: space-between; align-items: center;">
    ...
    <div class="col-12 col-md-6 d-flex justify-content-between mb-2 mb-md-0">
        ...
        <div class="d-flex">
            <form action="{{ route('theoretical_class.exportExcel') }}" method="POST" style="display: inline;">
                @csrf
                <button type="button" class="btn btn-primary mr-1" onclick="window.location.href='{{ route('theoretical_class.exportPdf') }}'">PDF</button>
