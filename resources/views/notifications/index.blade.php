...
<div class="container mt-5">
    ...
    <div class="row mb-3">
        ...
        <div class="col-12 col-md-6 d-flex justify-content-end">
            <form action="{{ Auth::guard('trainee')->check() ? route('student.notifications') : route('notifications.index') }}" method="GET" class="form-inline w-100">
    ...
    function markAsRead(notificationId) {
        ...
        .then(response => {
            if (response.ok) {
                ...
                const toggleText = document.getElementById(`toggle-text-${notificationId}`);
                toggleText.textContent = "View Details"; // Reset toggle text
            }
        })
        .catch(error => {
